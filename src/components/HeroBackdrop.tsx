      ...
      >
        ...
        <defs>
          <radialGradient id="halo" cx="82%" cy="16%" r="50%">
            <stop offset="0%" stopColor="#0c76fe" stopOpacity="0.10" />
            <stop offset="100%" stopColor="#0c76fe" stopOpacity="0" />
          </radialGradient>
        </defs>
        <rect width="1440" height="760" fill="url(#halo)" />
        <g stroke="#0c76fe" strokeWidth="1" opacity="0.28">
          {links.map(([a, b], i) => (
